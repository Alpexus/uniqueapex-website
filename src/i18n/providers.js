...
export default {
  en: {
    ...
    /* ---- map ---- */
    mapHint: "Tap a pin for the clinic's details and directions ✦ the gold star is your search area (approximate — only you can see it).",
...
{parent2}`,
  ...
  fr: {
    ...
    /* ---- map ---- */
    mapHint: "Touchez une épingle pour voir les détails de la clinique et l'itinéraire ✦ l'étoile dorée est votre secteur de recherche (approximatif — vous seule le voyez).",
