...
export default {
  en: {
    ...
    summaries_pickErr: "Could not reach your vault right now.",
    summaries_readBtn: "Read with AI",
    summaries_notLive: "The Report Reader is still rolling out — try the sample summary to see how it works.",
    summaries_reading: "Reading the report…",
    summaries_readingSub: "Usually under a minute. You can stay on this page.",
    summaries_sampleBadge: "Sample",
    summaries_sampleNote: "Illustrative example — not from your own documents.",
    summaries_original: "Open the original",
    summaries_resultTitle: "AI summary",
    summaries_findings: "Key findings",
    summaries_goals: "Goals identified",
    summaries_recs: "Recommendations",
    summaries_page: "p.",
    summaries_none: "Nothing found in this section.",
    summaries_passportTitle: "Suggested Passport updates",
    summaries_passportSub: "Tick what should carry over. Nothing is added until you confirm.",
    summaries_pComm: "Communication profile",
    summaries_pGoals: "Current goals",
    summaries_pHistory: "Therapy history",
    summaries_addBtn: "Review & add to Passport",
    summaries_another: "Read another report",
    summaries_added: "Saved to the Passport — you can edit it any time.",
    summaries_safety: "No diagnosis · No clinical advice · Nothing reaches your Passport without your confirmation",
  ...
  fr: {
    ...
    summaries_pickErr: "Impossible de joindre votre coffre-fort pour l'instant.",
    summaries_readBtn: "Lire avec l'IA",
    summaries_notLive: "Le Lecteur de rapports est en cours de déploiement — essayez l'exemple pour voir comment il fonctionne.",
    summaries_reading: "Lecture du rapport en cours…",
    summaries_readingSub: "Moins d'une minute en général. Vous pouvez rester sur cette page.",
    summaries_sampleBadge: "Exemple",
    summaries_sampleNote: "Exemple illustratif — ne provient pas de vos propres documents.",
    summaries_original: "Ouvrir l'original",
    summaries_resultTitle: "Résumé IA",
    summaries_findings: "Constats principaux",
    summaries_goals: "Objectifs identifiés",
    summaries_recs: "Recommandations",
    summaries_page: "p.",
    summaries_none: "Rien trouvé dans cette section.",
    summaries_passportTitle: "Mises à jour suggérées du passeport",
    summaries_passportSub: "Cochez ce qui doit être repris. Rien n'est ajouté avant votre confirmation.",
    summaries_pComm: "Profil de communication",
    summaries_pGoals: "Objectifs actuels",
    summaries_pHistory: "Historique des services",
    summaries_addBtn: "Réviser et ajouter au passeport",
    summaries_another: "Lire un autre rapport",
    summaries_added: "Enregistré dans le passeport — modifiable à tout moment.",
    summaries_safety: "Aucun diagnostic · Aucun avis clinique · Rien n'entre dans votre passeport sans votre confirmation",
